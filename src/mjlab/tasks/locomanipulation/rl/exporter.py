...
from mjlab.tasks.locomanipulation.mdp import MotionCommand
from mjlab.third_party.isaaclab.isaaclab_rl.rsl_rl.exporter import _OnnxPolicyExporter


def export_locomanipulation_policy_as_onnx(
  ...
  policy_exporter = _OnnxLocomanipulationPolicyExporter(env, actor_critic, normalizer, verbose)
  policy_exporter.export(path, filename)


class _OnnxLocomanipulationPolicyExporter(_OnnxPolicyExporter):
  def __init__(
